    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('completo', 'Completo'), ('fallido', 'Fallido')], default='pendiente', max_length=10)),
                ('metodo_pago', models.CharField(blank=True, max_length=50, null=True)),
                ('identificador_transaccion', models.CharField(blank=True, max_length=100, null=True)),
